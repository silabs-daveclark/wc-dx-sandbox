...
#define RSI_TCP_IP_FEATURE_BIT_MAP  (TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_TOTAL_SOCKETS_1 | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_SSL)

//! To set custom feature select bit map 
#define RSI_CUSTOM_FEATURE_BIT_MAP  FEAT_CUSTOM_FEAT_EXTENTION_VALID

//! To set Extended custom feature select bit map 
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP   (EXT_FEAT_384K_MODE | EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT |EXT_FEAT_SSL_CERT_WITH_4096_KEY_SUPPORT)//EXT_FEAT_256K_MODE

#define RSI_EXT_TCPIP_FEATURE_BITMAP  ( EXT_DYNAMIC_COEX_MEMORY | EXT_TCP_IP_FEAT_SSL_MEMORY_CLOUD )
